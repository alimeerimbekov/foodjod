        ...
        <Box sx={{minWidth: 120}}>
            <FormControl fullWidth>
                ...
                >
                    ...
                    <MenuItem className='catalog__aside-item' value={'minWeight'}>По весу от меньшего</MenuItem>
                    <MenuItem className='catalog__aside-item' value={'maxWeight'}>По весу от большего</MenuItem>
